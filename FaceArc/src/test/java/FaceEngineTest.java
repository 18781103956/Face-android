...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        String appId = "8nLLLN6v8dDrQAjjKFUfGaDDEV7esJSa7Rhi6bjdG5yU";
        String sdkKey = "FKHqq6LEVxWkfkgvyAAMhcj1FGNmAiY6c94dxTGFzLQu";

        FaceEngine faceEngine = new FaceEngine("C:\\Java_jar\\libs\\WIN64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("C:\\Users\\m1309\\Pictures\\图片\\1.jpg"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("C:\\Users\\m1309\\Pictures\\图片\\1.jpg"));
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("C:\\Users\\m1309\\Pictures\\图片\\1.jpg"));
        ...
        //IR活体检测
        ArrayList<IrLivenessInfo> irLivenessInfo = new ArrayList<>();
    ...
    private static void assertEquals(String 性别检测失败, int genderCode, int value) {
    }
